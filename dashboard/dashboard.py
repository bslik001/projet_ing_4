...
df = pd.read_csv('./dashboard/bank.csv')
...
kpi2.metric(label="Married", value=count_married, delta=round(count_married))
kpi3.metric(label="Balance", value=f"{balance:.2f}", delta=-round(balance/count_married)*100)
